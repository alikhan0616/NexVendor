          ...
          <div className="w-full flex border-b">
            <form className="w-full" onSubmit={paymentHandler}>
              ...
              <input
                type="submit"
                value="Submit"
                className={`${styles.button} !bg-[#B66E41] border-[#B66E41] text-[#fff] h-[45px] rounded-[5px] cursor-pointer text-[18px] font-[600]`}
              />
            </form>
          </div>
        ) : null}
    ...
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        ...
        <h5 className="text-[18px] font-[600]">
          ${orderData.subTotalPrice && orderData?.subTotalPrice.toFixed(2)}
        </h5>
      </div>
      <br />
      <div className="flex justify-between">
        ...
        <h5 className="text-[18px] font-[600]">
          ${orderData.shipping && orderData.shipping.toFixed(2)}
        </h5>
      </div>
      <br />
